...
void bod(){
	...
	fclose(g);
	printf("According to the data survey by %d employees, the following insights have been taken:\n\n",e_num);
	
	
		printf("\n\nOur company, Smart doko, should work more on developing public relations by sending free products to celebrities and other popular individual on the internet.\n The results of voting for this statement is %d out of %d.",c1,e_num);
